...
WEIGHTS_PATH = '/Users/ardhyantry/Documents/GitHub/snake-classification/coba/checkpoints/best_model.weights.h5'
...
# Use the dropout value from best hyperparameters (0.3 based on tuning_results.txt)
...
# Use the optimizer from best hyperparameters (adamw with lr=0.0001)
model.compile(
...
with open(output_file, 'w') as f:
    f.write("="*60 + "\n")
    f.write("SNAKE CLASSIFICATION - TEST SET EVALUATION REPORT\n")
    f.write("="*60 + "\n\n")
